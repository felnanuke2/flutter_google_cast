import 'package:flutter_chrome_cast_platform_interface/src/entities/discovery_criteria.dart';

/// Configuration options for Google Cast functionality.
class GoogleCastOptions {
  /// Cast application identifier, primarily used on Android.
  final String? appId;

  /// Discovery criteria payload, primarily used on iOS.
  final GoogleCastDiscoveryCriteriaInitialize? discoveryCriteria;
