import 'package:flutter_chrome_cast_platform_interface/src/entities/cast_session.dart';
import 'package:flutter_chrome_cast_platform_interface/src/entities/cast_device.dart';
import 'package:flutter_chrome_cast_platform_interface/src/entities/device_volume.dart';
import 'package:flutter_chrome_cast_platform_interface/src/enums/connection_state.dart';
...
abstract class GoogleCastSessionManagerPlatformInterface
  ...
  GoogleCastSessionManagerPlatformInterface() : super(token: _token);
  ...
  static GoogleCastSessionManagerPlatformInterface get instance {
    return _instance ??
        (throw UnimplementedError(
          'No implementation registered for GoogleCastSessionManagerPlatformInterface. '
  ...
  static set instance(GoogleCastSessionManagerPlatformInterface instance) {
...
//     4.0
  ...
  /// Sets the device volume.
  @Deprecated('Use setDeviceVolumeLevel with CastDeviceVolume.')
