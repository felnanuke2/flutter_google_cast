...
// `package:flutter_chrome_cast/entities/discovery_criteria.dart`.
// All types are now defined in the platform_interface package.
export 'package:flutter_chrome_cast_platform_interface/src/entities/discovery_criteria.dart';
